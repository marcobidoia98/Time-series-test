...
% X_=xlsread('FTSE Close---.xlsx'); %FTSE
% X_=xlsread('DJ Close---.xlsx'); %Dow Jones
X_=xlsread('NSX Close---.xlsx'); %NSX
% X_=xlsread('Hang Seng Close.xlsx');
% X_=xlsread('Nikkei 225 Close.xlsx');
% X_=xlsread('DAX Close.xlsx');
% X_=xlsread('CAC 40 Close.xlsx');
% X_=xlsread('S&P 100 Close.xlsx');
